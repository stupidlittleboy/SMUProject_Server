...
<script type="text/javascript">
	function click_button(button) {
		window.location.href='add_meeting.php';;
	}
	</script>
</head>   
<body>   
	<h1 align="center">会议信息</h1>
	<div   align="right"><button type="submit" name="add" onclick="click_button(this)"> 添加会议信息 </button></div>
...
<th width="40%" bgcolor="#E3E3E3" scope="col">会议内容</th>   
...
$sql="select * from meeting order by meeting_start desc limit $offset,$Page_size";   
$result=mysql_query($sql);   
while ($row=mysql_fetch_array($result)) {   
?>   
<form action="change_meeting.php" method="post">
<tr>   
